    ...
    {!! Session::get('message') !!}
      <div class="ibox float-e-margins">
            ...
            <div class="ibox-content">
                <form class="form-horizontal" role="form" method="post" action="{{ action('TweetController@getTweet') }}" novalidate="novalidate">
                {!! csrf_field() !!}
                    <div class="form-group" id="data_keywords"><label class="col-lg-2 control-label">Tanggal</label>
                        <div class="col-lg-10">
                            <div class="input-group date">
                                <span class="input-group-addon"><i class="fa fa-calendar"></i></span>
                                <input type="text" class="form-control" value="{{ date('m/d/Y') }}" name="date">
                            </div>
                    ...
                    <div class="form-group">
                        <div class="col-lg-offset-2 col-lg-10">
                            <button class="btn btn-sm btn-primary btn-rounded" type="submit">Unduh</button>
                        </div>
                    </div>
                </form>
            </div>
